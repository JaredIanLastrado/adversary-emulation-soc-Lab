...
Develop a custom Security Onion dashboard that provides centralized visibility into network-security events generated by Suricata and enables quick identification of alert trends, communication patterns, targeted services, protocol usage, and network-based threats.
...
Although individual alerts could be reviewed through the Security Onion interface, a dashboard provides a centralized operational view capable of displaying:
...
To improve visibility efficiency, a custom Security Onion dashboard was developed using Onion Query Language (OQL).
...
This visualization provides immediate visibility into the overall security posture of the environment.
...
This helps understand how individual detections contribute to broader categories of network activity.
...
- Dashboards significantly improve efficiency by centralizing telemetry.
...
A custom Security Onion Network Threat Monitoring Dashboard was developed to centralize Suricata alert telemetry and improve visibility into network security events.
