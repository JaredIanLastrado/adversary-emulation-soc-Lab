...
Develop a custom Security Onion dashboard that provides centralized visibility into network security events generated by Suricata, enables quick identification alert trends, communication patterns, targeted services, protocol usage, and network-based threats.
...
Although individual alerts could be reviewed through the Security Onion interface, a dashboard provides centralized operational view capable of displaying:
